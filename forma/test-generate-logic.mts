...
const sample: GeneratedWorksheet = {
  ...
  questions: [
    { id: 'q1', type: 'warm-up', parts: [makePart(null, 'Warm up 1')] },
    { id: 'q2', type: 'warm-up', parts: [makePart(null, 'Warm up 2')] },
    { id: 'q3', type: 'core', parts: [makePart(null, 'Core 1')] },
    { id: 'q4', type: 'core', parts: [makePart(null, 'Core 2')] },
    { id: 'q5', type: 'core', parts: [makePart(null, 'Core 3')] },
    { id: 'q6', type: 'core', parts: [makePart(null, 'Core 4')] },
    { id: 'q7', type: 'core', parts: [makePart(null, 'Core 5')] },
    { id: 'q8', type: 'core', parts: [makePart(null, 'Core 6')] },
    { id: 'q9', type: 'challenge', parts: [makePart(null, 'Challenge 1')] },
    { id: 'q10', type: 'challenge', parts: [makePart(null, 'Challenge 2')] },
  ],
};
