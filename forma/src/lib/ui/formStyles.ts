...
// the existing static shadow-card. Not swapped into every existing card
// usage this session (that's Phase 4 - see CLAUDE.md's Design System v2
// section) - available now for anything newly built as interactive.
export const interactiveCardClass =
  'bg-[#F0EBE3] border-[0.5px] border-[#E0D9D0] rounded-[12px] p-6 shadow-card hover:shadow-raised hover:border-[#C4B9AC] hover:-translate-y-0.5 transition-all duration-micro ease-premium';
